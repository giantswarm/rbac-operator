...
### Added
- Added validation to ensure no roles or bindings have cluster-admin permissions.
...
[Unreleased]: https://github.com/giantswarm/rbac-operator/compare/v0.41.0...HEAD
