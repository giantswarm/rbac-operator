...
func mainE(ctx context.Context) error {
	...
	daemonCommand.PersistentFlags().String(f.Service.NamespaceAuth.ViewAllTargetGroup, "", "Identity provider group, allowed to view all resources in tenant namespace.")
	daemonCommand.PersistentFlags().String(f.Service.NamespaceAuth.TenantAdminTargetGroup, "", "Identity provider group, allowed to write all resources in tenant namespace.")
