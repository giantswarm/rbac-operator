...
func mainE(ctx context.Context) error {
	...
	daemonCommand.PersistentFlags().String(f.Service.NamespaceAuth.WriteAllTargetGroup, "", "Identity provider group, allowed to write all resources in tenant namespace.")
